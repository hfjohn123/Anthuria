...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="no-scrollbar overflow-y-auto duration-300 ease-linear basis-full">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-5 py-4 px-4 lg:mt-6 lg:px-6 flex flex-col h-full justify-between">
          {/* <!-- Menu Group --> */}
          <div>
