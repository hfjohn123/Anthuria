            ...
            <th className="text-left pt-2.5 w-2/12">
              <div className="flex gap-1.5">
                ...
                <Bot
                  ...
                  data-tooltip-content="Text generated by AI from Progress Note"
            ...
            ({ trigger_word, status, summary, comment, is_thumb_up }) => (
              <tr key={row.id + trigger_word}>
                <td className="whitespace-nowrap pt-2.5 align-top flex items-center flex-nowrap">
                  ...
                  <div
                    className={clsx(
                      'rounded-full hover:bg-blue-100 cursor-pointer dark:hover:bg-slate-700 p-1 ml-1 ',
                    )}
...
export default function TriggerWords() {
  ...
  return (
    <DefaultLayout title={'Clinical Pulse'}>
      <div className="grid xl:grid-cols-5 grid-cols-3 sm:gap-10">
