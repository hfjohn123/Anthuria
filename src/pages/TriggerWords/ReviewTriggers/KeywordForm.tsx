      ...
      onMutate: async () => {
        ...
        setSelfDefinedKeywordsState((prev) => [
          ...prev.filter((d) => d.group_name !== initialNewTrigger.group_name),
          {
            ...
            keyword_list: newTriggerWord.keyword_list,
            internal_facility_id: newTriggerWord.internal_facility_id,
          },
        ]);
      },
      onSettled: () => {
          ...
          <Field>
            ...
            <Chips
              ...
              pt={{
                ...
                token: () =>
                  'has-[.bg-yellow-200]:bg-yellow-200 has-[.bg-green-200]:bg-green-200 has-[.bg-blue-200]:bg-blue-200 has-[.bg-pink-200]:bg-pink-200 has-[.bg-purple-200]:bg-purple-200 has-[.bg-orange-200]:bg-orange-200 has-[.bg-teal-200]:bg-teal-200',
              }}
              itemTemplate={(item) =>
